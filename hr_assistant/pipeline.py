...
def build_hr_assistant(file_path: str = config.DATA_FILE_PATH):
    ...
    logger.info("HR assistant is ready to take the questions")
    return agent
def ask(agent, question: str) -> str:
    ...
    #input guard - to get safe imnputs
    ...
    # output guard - to check if agent gives safe answers
